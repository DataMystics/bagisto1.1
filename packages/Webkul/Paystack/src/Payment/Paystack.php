...
abstract class Paystack extends Payment
{
    ...
    {
        return sprintf('https://www.%spaystack.com/cgi-bin/webscr%s',
    ...
    /**
     * Format a currency value according to paystack's api constraints
     *
    ...
    /**
     * Format phone field according to paystack's api constraints
     *
