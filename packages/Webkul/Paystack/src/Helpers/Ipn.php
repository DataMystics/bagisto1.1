...
class Ipn
{
    ...
    public function __construct(
        protected Standard $paystackStandard,
        protected OrderRepository $orderRepository,
        protected InvoiceRepository $invoiceRepository
    ) {}

    /**
     * This function process the IPN sent from paystack end.
     *
     * @param  array  $post
    ...
    /**
     * Post back to paystack to check whether this request is a valid one.
     *
     * @return bool
     */
    protected function postBack()
    {
        $url = $this->paystackStandard->getIPNUrl();
